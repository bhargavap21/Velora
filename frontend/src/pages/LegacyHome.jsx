    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center px-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle className="text-2xl">StratRL (legacy)</CardTitle>
            <CardDescription>Claude-powered strategy optimizer — prior project, not part of this hackathon submission</CardDescription>
          </CardHeader>
          <CardContent>
